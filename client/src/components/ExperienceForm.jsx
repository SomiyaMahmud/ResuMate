                        ...
                        <div key={index} className='p-4 border border=gray-200 rounded-lg space-y-3'>
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                <div className='relative'>
                                    <input value={experience.company || ""} onChange={(e)=>updateExperience(index,"company",e.target.value)} type="text" placeholder='Company Name' className='px-3 py-2 pr-12 text-sm rounded-lg w-full'/>
                                    <VoiceInputButton 
                                ...
                                <div className='relative'>
                                    <input value={experience.position || ""} onChange={(e)=>updateExperience(index,"position",e.target.value)} type="text" placeholder='Job Title' className='px-3 py-2 pr-12 text-sm rounded-lg w-full'/>
                                    <VoiceInputButton 
                            ...
                            <div className='space-y-2'>
                                ...
                                <div className='relative'>
                                    <textarea value={experience.description || ""} onChange={(e)=>updateExperience(index,'description',e.target.value)} rows={4} className='w-full text-sm px-3 py-2 pr-12 rounded-lg resize-none' placeholder='Describe your key responsibilities and achievements.......'/>
                                    <VoiceInputButton 
