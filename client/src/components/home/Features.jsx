...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <div className="flex items-center gap-2 text-sm text-green-600 bg-green-600/10 rounded-full px-4 py-1">
                <Zap width={14}/>
                <span>Make Process Simple</span>
            </div>

            <Title title= 'Build Your Own Resume With AI' description= 'Our Streamlined Process Will Helps You to Create a Professional Resume in Minutes With Intelligent AI-Powered Tools and Features'/>
