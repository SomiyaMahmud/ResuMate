            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        <a href="#" className="hover:text-green-800 transition text-xl">Home</a>
                        <a href="#features" className="hover:text-green-800 transition text-xl">Features</a>
                        <a href="#testimonials" className="hover:text-green-800 transition text-xl">Testimonials</a>
                        <a href="#cta" className="hover:text-green-800 transition text-xl">Contact</a>
                    </div>

                    <div className="flex gap-2">
                        <Link to= '/app?state=register' className="hidden md:block px-6 py-2 bg-green-600 hover:bg-green-700 active:scale-95 transition-all rounded-full text-white">
                            Get started
                        </Link>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <p className="max-w-md text-center text-base my-7">Create,Edit,Download and Share Your Professional Resume With AI-powered Assistance .</p>
