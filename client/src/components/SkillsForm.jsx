    ...
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <div className='relative flex-1'>
                <input type="text" placeholder='Enter Your Skill(e.g Javascript,python,react..)' className='w-full px-3 pt-2 pr-12 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
                <VoiceInputButton 
                    value={newSkill} 
