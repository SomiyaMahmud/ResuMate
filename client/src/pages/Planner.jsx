...
const Planner = () => {
  // Move useLanguage to the top level (CRITICAL FIX)
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className='pr-24'>
                          ...
                          <h4 className={`font-semibold text-lg mb-1 ${plan.status === 'cancelled' ? 'line-through' : ''}`}>
                            {plan.companyName}
                          </h4>
                          ...
                          <div className='flex gap-2 mt-3 flex-wrap'>
                            {plan.status !== 'completed' && (
                              <button
                                onClick={() => quickUpdateStatus(plan._id, 'completed')}
                                className='bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-md text-xs font-medium flex items-center gap-1'
                              >
                            ...
                            {plan.status !== 'cancelled' && (
                              <button
                                onClick={() => quickUpdateStatus(plan._id, 'cancelled')}
                                className='bg-gray-600 hover:bg-gray-700 text-white px-3 py-1 rounded-md text-xs font-medium flex items-center gap-1'
                              >
                            ...
                            {plan.status !== 'scheduled' && (
                              <button
                                onClick={() => quickUpdateStatus(plan._id, 'scheduled')}
                                className='bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-1 rounded-md text-xs font-medium flex items-center gap-1'
                              >
                            ...
                            <button
                              ...
                              className='bg-slate-600 hover:bg-slate-700 text-white px-3 py-1 rounded-md text-xs font-medium'
                            >
                              {t('editButton')}
                            </button>
                            <button
                              onClick={() => handleDeletePlan(plan._id)}
                              className='bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded-md text-xs font-medium flex items-center gap-1'
                            >
