            ...
            <div className='max-w-5xl mx-auto px-4 py-8'>
                ...
                <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden'>
                    ...
                    <div className='p-8'>
                        ...
                        <div className='grid md:grid-cols-2 gap-6 mb-8 pb-8 border-b border-slate-200 dark:border-slate-700'>
                            ...
                            <div className='flex items-start gap-3'>
                                ...
                                <div>
                                    ...
                                    <p className='font-semibold text-slate-900 dark:text-white'>{job.views} views</p>
                                </div>
                            </div>
                        ...
                        {job.skills?.length > 0 && (
                            <div className='mb-8'>
                                <h2 className='text-2xl font-bold text-slate-900 dark:text-white mb-4'>Required Skills</h2>
                                <div className='flex flex-wrap gap-2'>
                        ...
                        <div className='bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10 rounded-xl p-6 border-2 border-indigo-200 dark:border-indigo-800'>
                            <h2 className='text-xl font-bold text-slate-900 dark:text-white mb-4'>How to Apply</h2>
