                                ...
                                >
                                    {!resumeFile ? (
                                        <div className='p-8 text-center'>
                                            ...
                                            <p className='text-xs text-slate-500 dark:text-slate-500'>PDF file only</p>
                                        </div>
                                    ) : isUploading ? (
                                        <div className='p-8 text-center'>
                ...
                {analysis && (
                    <div ref={reportRef} className='space-y-8'>
                        ...
                        <div className='flex items-center justify-between bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-6'>
                            <div>
                                <h2 className='text-2xl font-bold text-slate-900 dark:text-white mb-1'>Analysis Results</h2>
                        ...
                        <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-lg border-2 border-slate-200 dark:border-slate-800 overflow-hidden'>
                            ...
                            <div className='p-8 text-center'>
                                ...
                                <h3 className='text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase mb-2'>ATS Match Score</h3>
                                <div className={`text-7xl font-bold mb-2 ${getScoreColor(analysis.atsScore)}`}>
                                    {analysis.atsScore}
                                </div>
                                <p className='text-slate-500 dark:text-slate-400 text-lg'>out of 100</p>
                        ...
                        <div className='grid md:grid-cols-3 gap-6'>
                            <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-6'>
                                ...
                                <h3 className='text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase mb-2'>Hard Skills</h3>
                            ...
                            <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-6'>
                                ...
                                <h3 className='text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase mb-2'>Soft Skills</h3>
                            ...
                            <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-6'>
                                ...
                                <h3 className='text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase mb-2'>Experience</h3>
                        ...
                        <div className='grid md:grid-cols-2 gap-6'>
                            <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-8'>
                                <div className='flex items-center gap-3 mb-6'>
                                    ...
                                    <h3 className='text-xl font-bold text-slate-900 dark:text-white'>Matched Keywords</h3>
                            ...
                            <div className='bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-8'>
                                <div className='flex items-center gap-3 mb-6'>
                                    ...
                                    <h3 className='text-xl font-bold text-slate-900 dark:text-white'>Missing Keywords</h3>
                        ...
                        {analysis.suggestions && (
                            <div className='bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 rounded-2xl shadow-lg border-2 border-amber-200 dark:border-amber-800 p-8'>
                                <div className='flex items-center gap-3 mb-6'>
                                    ...
                                    <h3 className='text-2xl font-bold text-slate-900 dark:text-white'>AI-Powered Suggestions</h3>
                                </div>

                                <div className='space-y-6'>
                                    {analysis.suggestions.improvedSummary && (
                                        <div>
                                            <h4 className='font-semibold text-slate-900 dark:text-white mb-3'>Optimized Professional Summary</h4>
                                    ...
                                    {analysis.suggestions.skillsToAdd?.length > 0 && (
                                        <div>
                                            <h4 className='font-semibold text-slate-900 dark:text-white mb-3'>Add These Skills</h4>
                                            <div className='flex flex-wrap gap-2'>
                                    ...
                                    {analysis.suggestions.overallTips?.length > 0 && (
                                        <div>
                                            <h4 className='font-semibold text-slate-900 dark:text-white mb-3'>Optimization Tips</h4>
